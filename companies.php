...
<div class="container">
  ...
  <div id="tab-1" class="tab-content current center-align">
    <img class="responsive-img center-align" src="images/marvelcompany.jpg">
    <p></p>
  ...
  <div id="tab-2" class="tab-content center-align">
    <img class="responsive-img center-align" src="images/universalpic.jpg">
    <p></p>
     Universal Pictures is an American film studio owned by Comcast through the Universal Filmed Entertainment Group division of its wholly owned subsidiary NBCUniversal.Founded in 1912 by Carl Laemmle, Mark Dintenfass, Charles O. 
     <p></p>
     Baumann, Adam Kessel, Pat Powers, William Swanson, David Horsley, Robert H. Cochrane, and Jules Brulatour, it is the oldest surviving film studio in the United States, the world's fifth oldest after Gaumont, Pathé, Titanus, and Nordisk Film, and the oldest member of Hollywood's "Big Five" studios in terms of the overall film market. 
  </div>
  <div id="tab-3" class="tab-content center-align">
    <img class="responsive-img center-align" src="images/un.png"> 
    <p></p>
  ...
  <div id="tab-4" class="tab-content center-align">
    <img class="responsive-img center-align" src="images/ic.jpg">
    <p></p>
    Image Comics lands number three on the list with a 12.64% unit share. The company was founded in 1992 and honed in on the superhero genre. Later, however, many independent writers lent their work to the company. 
    <p></p>
    Todd McFarlane, Jim Lee, Whilce Portacio, Marc Silvestri, Erik Larsen, Jim Valentino, and Rob Liefeld are the founders of the company.
  </div>
...
<h5 class="center">Contact Us</h5>
  <ul>
    <li style="color:blue;"> Name: Best Team!</li>
    <li style="color:red;">Adress: Ulonu Street</li>
    <li style="color:green;">City: Vilnius</li>
    <li style="color:slateblue;">Country: Lithuania</li>
    <li style="color:orange;">Mobile: 666 777</li>
    <li style="color:purple;">Email: bestteam@marvel.com</li>
  </ul>
